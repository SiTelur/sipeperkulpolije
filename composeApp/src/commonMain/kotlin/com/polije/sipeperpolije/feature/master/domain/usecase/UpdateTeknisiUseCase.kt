...
class UpdateTeknisiUseCase(private val masterRepository: MasterRepository) {
    suspend operator fun invoke(teknisi: TeknisiEntity): Result<Boolean> = masterRepository.updateTeknisi(teknisi)
}