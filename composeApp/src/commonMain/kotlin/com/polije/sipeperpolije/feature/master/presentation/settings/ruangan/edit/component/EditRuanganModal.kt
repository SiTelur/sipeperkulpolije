...
@Composable
fun EditRuanganModal(
    modifier: Modifier = Modifier,
    modalBottomSheetState: SheetState,
    id: Int,
    initialNamaRuangan: String,
    initialTipeRuangan: TipeRuangan,
    onSave: (hari: RuanganUI) -> Unit,
    onDismissRequest: () -> Unit
) {

    val namaRuangan = rememberTextFieldState(initialNamaRuangan)
    var (tipeRuangan, setTipeRuangan) = remember { mutableStateOf(initialTipeRuangan) }
